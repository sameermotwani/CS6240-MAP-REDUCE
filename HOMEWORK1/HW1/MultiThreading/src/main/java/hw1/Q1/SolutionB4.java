...
class SolutionB4Thread implements Runnable
{

	private List<String> Input;
	public ConcurrentHashMap<String,Float[]> allTmaxRecords;

	public SolutionB4Thread(List<String> Input, ConcurrentHashMap<String,Float[]> TotalTmaxPerStation){
		this.Input=Input;
...
public class SolutionB4
{
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		for (int i = 0; i < 10; i++) {
			...
			Thread t1=new Thread(new SolutionB4Thread(Input1,allTmaxRecords));
			Thread t2=new Thread(new SolutionB4Thread(Input2,allTmaxRecords));
			Thread t3=new Thread(new SolutionB4Thread(Input3,allTmaxRecords));
			Thread t4=new Thread(new SolutionB4Thread(Input4,allTmaxRecords));
		...
		File op=new File("output/B4Output.csv");
