...
class SolutionB5Thread implements Runnable
{
	private List<String> Input;
	String threadName;
	public Map<String,Float[]> allTmaxRecords=new HashMap<String, Float[]>();

	public SolutionB5Thread(List<String> Input, String Thread){
		this.Input=Input;
...
public class SolutionB5
{
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		SolutionB5Thread sb1=new SolutionB5Thread(Input1,"Thread1");
		SolutionB5Thread sb2=new SolutionB5Thread(Input2,"Thread2");
		SolutionB5Thread sb3=new SolutionB5Thread(Input3,"Thread3");
		SolutionB5Thread sb4=new SolutionB5Thread(Input4,"Thread4");
		...
		File op=new File("output/B5Output.csv");
